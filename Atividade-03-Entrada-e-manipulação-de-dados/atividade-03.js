...
// Questão 8
var numero3 = Number(prompt("Digite o primeiro número:"));
var numero4 = Number(prompt("Digite o segundo número:"));
if (numero3 !== null && numero4 !== null) {
    console.log("Questão 8: " + (numero3 + numero4));
}
//Questão 9
var decimal = Number(prompt("Digite um número decimal: "));
console.log("Questão 9: " + Math.pow(decimal, 2));
//Questão 10
...
var segundoNome = String(prompt("Digite seu sobrenome nome"));
...
console.log("".concat(estadoCivil == "solteiro" || estadoCivil == "solteira"
...
//Questão 22
var baseTriangulo = Number(prompt("Digite a base de um triangulo: "));
var alturaTriangulo = Number(prompt("Digite a altura de um triangulo: "));
...
if (cidade != null) {
    console.log("".concat(cidade.toLocaleLowerCase().charAt(0) == "s"
...
console.log("Questão 24: O resto da divisão dos números decimais que você digitou é: " +
...
//Questão 29
console.log("Questão 29: Bem-vindo ao nosso programa, nascido em " + anoNascimento);
//Questão 30
...
//Questão 32
console.log("Questão 31: O dobro de " + numInt + " é igual a " + Math.pow(numInt, 2));
//Questão 33
var email = prompt("Digite seu e-mail: ");
console.log("Questão 33: Obrigada por se inscrever. Enviaremos mais notícias para o e-mail: " +
    email);
//Questão 34
console.log("Questão 34: A soma de" + num + " + " + numInt + " é " + (num + numInt));
console.log("Questão 34: A diferença de " +
    num +
    " + " +
    numInt +
    " é " +
    Math.abs(num - numInt));
console.log("Questão 34: O produto de " + num + " + " + numInt + " é " + num * numInt);
console.log("Questão 34: O quociente de " + num + " + " + numInt + " é " + num / numInt);
//Questão 35
...
//Questão 37
console.log("Questão 37: O perímetro do triângulo 1 é: " +
    2 * (baseTriangulo + alturaTriangulo));
//Questão 38
console.log("Questão 38: A média aritmética entre os três números decimais já digitados aqui é: " +
